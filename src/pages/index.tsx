        ...
        <>
            ...
            <>
                ...
                <div id='explore-block' className="text-center content-center my-12 flex flex-col">
                    ...
                    <span className="font-bold text-6xl">Looking for new technologies</span>
                    <p className='max-w-4xl mx-auto my-4'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                ...
                <div id='collaborate-block' className="text-center content-center my-12 flex flex-col">
                    ...
                    <span className="font-bold text-6xl">Finding like minded people</span>
                    <p className='max-w-4xl mx-auto my-4'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
                        voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat
                ...
                <div id='empower-block' className="text-center content-center my-12 flex flex-col">
                    ...
                    <span className="font-bold text-6xl">Giving the power to the people</span>
                    <p className='max-w-4xl mx-auto my-4'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
                        voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat
